# Generated by Django 3.2.19 on 2023-05-08 13:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('support_view', 'can view tickets'), ('support_edit', 'can edit tickets'), ('activity_view', 'can view recruiters, applicants, data, posts'), ('activity_edit', 'can edit data'), ('jobposts_edit', 'can manage jobposts'), ('jobposts_invoice_access', 'can manage invoice'), ('jobposts_resume_profiles', 'can manage resume profiles')),
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Exprired', 'Expired'), ('Live', 'Live'), ('Disabled', 'Disabled'), ('Pending', 'Pending'), ('Published', 'Published'), ('Hired', 'Hired'), ('Process', 'Process')], max_length=50)),
                ('previous_status', models.CharField(choices=[('Draft', 'Draft'), ('Exprired', 'Expired'), ('Live', 'Live'), ('Disabled', 'Disabled'), ('Pending', 'Pending'), ('Published', 'Published'), ('Hired', 'Hired'), ('Process', 'Process')], default='Draft', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='peeldb.jobpost')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peeldb.language')),
            ],
        ),
        migrations.CreateModel(
            name='UserEmail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page_or_profile', models.CharField(choices=[('Page', 'Page'), ('Profile', 'Profile')], max_length=50)),
                ('post_id', models.CharField(max_length=500)),
                ('post_status', models.CharField(choices=[('Posted', 'Posted'), ('Deleted', 'Deleted')], max_length=50)),
                ('job_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peeldb.jobpost')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stackoverflow', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Solution',
        ...
        migrations.AddField(
            model_name='jobpost',
            name='visa_country',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='visa_country', to='peeldb.country'),
        ),
        migrations.CreateModel(
            name='JobAlert',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page_or_group', models.CharField(choices=[('Page', 'Page'), ('Group', 'Group'), ('Bubbas', 'Bubbas')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='facebook_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peeldb.degree')),
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peeldb.educationinstitue')),
            ],
        ),
        migrations.AddField(
            model_name='degree',
            name='degree_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peeldb.qualification'),
        ),
        migrations.CreateModel(
            name='DailySearchLog',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='categories', to='peeldb.AgencyCompanyCatogery'),
        ),
        migrations.AddField(
            model_name='agencycompany',
            name='contract_details',
            field=models.ManyToManyField(related_name='contract_details', to='peeldb.AgencyContractDetails'),
        ),
        migrations.AddField(
            model_name='agencycompany',
            name='created_by',
        ...
        migrations.AddField(
            model_name='user',
            name='city',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_city', to='peeldb.city'),
        ),
        migrations.AddField(
            model_name='user',
            name='company',
        ...
        migrations.AddField(
            model_name='user',
            name='country',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='peeldb.country'),
        ),
        migrations.AddField(
            model_name='user',
            name='current_city',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='peeldb.industry'),
        ),
        migrations.AddField(
            model_name='user',
            name='preferred_city',
            field=models.ManyToManyField(related_name='preferred_city', to='peeldb.City'),
        ),
        migrations.AddField(
            model_name='user',
            name='project',
        ...
        migrations.AddField(
            model_name='user',
            name='state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='peeldb.state'),
        ),
        migrations.AddField(
            model_name='user',
